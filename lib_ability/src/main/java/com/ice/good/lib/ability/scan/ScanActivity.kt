package com.ice.good.lib.ability.scan
...
class ScanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rect = Rect()
        val screenWidth = DisplayUtil.getDisplayWidthInPx(this)
        val screenHeight = DisplayUtil.getDisplayHeightInPx(this)
        val scanFrameSize = DisplayUtil.dp2px(240f)
        ...
        //是否支持闪光灯
        remoteView.setOnLightVisibleCallback { visble->
            flush_btn.visibility = if (visble) View.VISIBLE else View.GONE
        }
    ...
    private fun showResult(hmsScan: HmsScan) {
        ...
        YLog.i("scan_type:" + hmsScan.scanType + ",scan_reuslt：" + hmsScan.originalValue)
        finish()
    }
