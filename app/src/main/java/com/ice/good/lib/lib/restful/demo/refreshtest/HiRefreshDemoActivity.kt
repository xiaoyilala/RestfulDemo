...
import com.ice.good.lib.ui.refresh.IRefresh
import com.ice.good.lib.ui.refresh.RefreshLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        refreshLayout.setRefreshListener(object :
            ...
            override fun onRefresh() {
                Handler().postDelayed({ refreshLayout.refreshFinish() }, 1000)
            }
...
// - replace the contents of the view with that element
            ...
            holder.itemView.setOnClickListener { YLog.d("position:$position") }
        }
