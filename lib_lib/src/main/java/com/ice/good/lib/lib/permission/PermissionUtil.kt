package com.ice.good.lib.lib.permission
...
import com.ice.good.lib.lib.permission.PermissionUtil.OnRationaleListener.ShouldRequest
import java.util.*
...
class PermissionUtil private constructor(vararg permissions: String) {
    ...
    class PermissionActivity : Activity() {
        ...
        override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
            ...
            if (requestCode == TYPE_WRITE_SETTINGS) {
                ...
                MainHandler.postDelay(100, Runnable {
    ...
    companion object {
         ...
         * @return the single [PermissionUtil] instance
         *
