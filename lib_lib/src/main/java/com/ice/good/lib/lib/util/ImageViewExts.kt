...
fun ImageView.loadUrl(url: String) {
    if (ViewUtil.isActivityDestroyed(context) || TextUtils.isEmpty(url)) return
...
fun ImageView.loadCircle(circleUrl: String?) {
    if (ViewUtil.isActivityDestroyed(context) || TextUtils.isEmpty(circleUrl)) return
...
fun ImageView.loadCircleBorder(
    ...
    if (ViewUtil.isActivityDestroyed(context) || TextUtils.isEmpty(url))
