package com.ice.good.lib.ui.banner.indicator;
 ...
 * 数字指示器
 */
public class NumIndicator extends FrameLayout implements IIndicator<FrameLayout> {
    ...
    @Override
    public void onChange(int current, int count) {
